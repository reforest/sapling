...
let brownShades = [
	createMaterial(0xA52A2A),
	createMaterial(0x964B00),
	createMaterial(0xA52A2A),
	createMaterial(0xFFBF00),
	createMaterial(0x9F8170),
	createMaterial(0xF5F5DC),
	createMaterial(0xF0DC82),
	createMaterial(0x8A3324),
	createMaterial(0x954535),
	createMaterial(0x7B3F00),
	createMaterial(0xD2691E),
	createMaterial(0xEDC9AF),
	createMaterial(0xC3B091),
	createMaterial(0x6B4423),
	createMaterial(0xCD853F),
	createMaterial(0x826644),
	createMaterial(0xBC8F8F),
	createMaterial(0x80461B),
	createMaterial(0xF4A460),
	createMaterial(0x832A0D),
	createMaterial(0xD2B48C),
	createMaterial(0x483C32),
	createMaterial(0xC19A6B),
]

module.exports = {
	greenShades : greenShades,
	brownShades : brownShades,
	materials : materials
};